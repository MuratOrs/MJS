...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.index = function () {
  ...
  const child = [...parent.children]; //convert into an array
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.closest = function (selector) {
  ...
  if (!document.querySelector(selector)) {
    console.warn("There's no such parent class");
    return this;
  }
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.getAtt = function (dataName) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.hasAtt = function (dataName) {
  if (!dataName) return this;
  for (let i = 0; i < this.length; i++) {
...
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('button').on('click', function () {
  (0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('div').eq(1).toggleClass('active').find();
});
console.log((0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('button').html('hallo'));
...
console.log((0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.findme').siblings().addClass('red'));
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.findme').fadeOut(1500);
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('button').fadeIn(6000);
})();
